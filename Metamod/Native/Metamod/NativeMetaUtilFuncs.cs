...
#pragma warning disable CS8500 // 这会获取托管类型的地址、获取其大小或声明指向它的指针
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate QBoolean IsAddressInModuleRangeDelegate(nint lpAddress, nint lpModuleBase);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate QBoolean IsValidCodePointerInEngineDelegate(nint ptr);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate QBoolean UnHookDelegate(NativeHook pHook);
